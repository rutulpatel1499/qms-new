                                        ...
                                        <div class="row">
                                            ...
                                            <i class="fa fa-user-o prefix white-text"></i>
                                                ...
                                                <input type="text" class="form-control" name="name" id="inputname"
                                                    placeholder="enter your name"  value="{{ $client->name }}"disabled>
                                                @error('name')
                                                    {{$message}}
                                                @enderror
                                            </div>
                                            ...
                                            <i class="fa fa-envelope-o prefix white-text"></i>
                                                ...
                                                <input type="email" class="form-control" name="email" id="inputemail"
                                                    placeholder="enter your email"  value="{{ $client->email }}"disabled>
                                                @error('email')
                                                    {{$message}}
                                                @enderror
                                            </div>
                                            ...
                                            <i class="fa fa-address-card-o prefix white-text"></i>
                                                ...
                                                <input type="text" class="form-control" name="address" id="inputaddress"
                                                    placeholder="enter your address"  value="{{ $client->address }}"disabled>
                                                @error('address')
                                                    {{$message}}
                                                @enderror
                                            </div>
                                            ...
                                            <i class="fa fa-mobile prefix white-text"></i>
                                                ...
                                                <input type="text" class="form-control" name="contactno" id="inputcontact_no"
                                                    placeholder="enter your contact_no"  value="{{ $client->contact_no }}"disabled>
                                                @error('contact_no')
                                                    {{$message}}
                                                @enderror
                                            </div>
